...
//import { get_data_config, get_new_item, get_cloud_url, get_biz_item  } from './';
//import { get_test_item,w  } from 'biz9-utility-js';
/* --- TEST CONFIG START --- */
//const ID='0';
/*
...
describe("old_connect", () => {
    it("old_connect", () => {
        async.series([
            ...
            function(call) {
                console.log('GET-NEW-ITEM-START'); var _new_item = get_new_item(DATA_TYPE,0);
